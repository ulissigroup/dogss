...
SDT_list = pickle.load(open('../../../input_CO_ads/SDT_list_new.pkl', 'rb'))
docs = pickle.load(open('../../../input_CO_ads/final_docs_new.pkl', 'rb'))
...
clf = SigOptSearchCV(net, net_parameters, cv=train_test_splitter, client_token=client_token,
                    n_jobs=1, n_iter=50, scoring=get_scorer('neg_mean_squared_error'),experiment=experiment)
